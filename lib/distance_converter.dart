...
class _DistanceConverterState extends State<DistanceConverter> {
  ...
  void _convertDistance() {
    ...
    setState(() {
      _convertedDistance = convertedValue.toStringAsFixed(4);
    });
  }
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _buildTitle('Enter distance:', accentColor),
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(Icons.straighten, color: accentColor),
          ),
        ),
      ),
    );
    ...
    return Center(
      child: Card(
        ...
        child: Padding(
          ...
          child: Text(
            _convertedDistance.isEmpty || _convertedDistance == 'Invalid input'
                ? 'Converted Distance'
                : '$_convertedDistance $_selectedToUnit',
            style: TextStyle(
              fontSize: MediaQuery.of(context).size.width * 0.052,
              color: _convertedDistance == 'Invalid input' ? Colors.red : accentColor,
              fontWeight: FontWeight.bold,
              letterSpacing: 1.1,
            ),
