...
class _CalculatorState extends State<Calculator> {
  // Variables
  String display = 'WELCOME TO PENTACULATOR!';
  String expression = '';
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  if (history.isNotEmpty) // Conditionally display the button
                    ElevatedButton(
                      style: ElevatedButton.styleFrom(
...
void calculation(String buttonText) {
  setState(() {
    ...
    if (display == 'Error') {
      // If an error is displayed, pressing any button will reset the display
      if (buttonText == '⌫') {
        display = '0';
        expression = '';
